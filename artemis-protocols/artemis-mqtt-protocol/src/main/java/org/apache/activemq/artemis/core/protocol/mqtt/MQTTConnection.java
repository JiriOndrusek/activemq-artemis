...
public class MQTTConnection implements RemotingConnection {
   ...
   public CountDownLatch fail(ActiveMQException me) {
      ...
      //TODO(jondruse) should there be waiting (blocking) for failures from listener.connectionFails?
   ...
   public CountDownLatch fail(ActiveMQException me, String scaleDownTargetNodeID) {
      ...
      //TODO(jondruse) should there be waitng (blocking) for failures from listener.connectionFails?
      return new CountDownLatch(0);
   }
