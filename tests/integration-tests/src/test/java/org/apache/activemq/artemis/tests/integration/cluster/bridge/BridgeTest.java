...
public class BridgeTest extends ActiveMQTestBase {
   ...
   public void testBlockedBridgeAndReconnect() throws Exception {
      ...
      Assert.assertTrue("bridge is never blocked", bridge.isBlockedOnFlowControl());
      ...
      Assert.assertEquals(0, server0.locateQueue(SimpleString.toSimpleString("queue0")).getMessageCount());
