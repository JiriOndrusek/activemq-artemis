...
public class DeleteMessagesOnStartupTest extends StorageManagerTestBase {
   ...
   public void testDeleteMessagesOnStartup() throws Exception {
      ...
      journal.loadMessageJournal(postOffice, null, null, null, null, null, null, new PostOfficeJournalLoader(postOffice, null, journal, null, null, null, null, null, null, queues));
