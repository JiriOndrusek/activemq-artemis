...
public class DuplicateDetectionUnitTest extends ActiveMQTestBase {
   ...
   public void testReloadDuplication() throws Exception {
      ...
      try {
         ...
         journal.loadMessageJournal(postOffice, pagingManager, new ResourceManagerImpl(0, 0, scheduledThreadPool), null, mapDups, null, null, new PostOfficeJournalLoader(postOffice, pagingManager, null, null, null, null, null, null, null));
