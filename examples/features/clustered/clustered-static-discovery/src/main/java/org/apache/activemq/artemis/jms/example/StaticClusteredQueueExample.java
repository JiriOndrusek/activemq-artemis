...
//      Connection connection3 = null;
      ...
      try {
         ...
         ConnectionFactory cf0 = new ActiveMQConnectionFactory("tcp://node2.domain:61617");
...
//         int con3Node = ServerUtil.getServer(connection3);
         if (con0Node + con1Node/* + con2Node + con3Node */!= 1) {
         ...
         for (int i = 0; i < numMessages; i += 2) {
            ...
            if(message0 == null) {
               throw new IllegalStateException("Bridge is not working");
            }
