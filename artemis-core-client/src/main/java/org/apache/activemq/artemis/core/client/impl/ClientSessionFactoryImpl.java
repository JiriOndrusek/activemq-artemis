...
public class ClientSessionFactoryImpl implements ClientSessionFactoryInternal, ClientConnectionLifeCycleListener {
   ...
   public void connect(final int initialConnectAttempts,
      ...
      //TODO(jondruse) should this stay blocking?
   ...
   public void connectionException(final Object connectionID, final ActiveMQException me) {
      ...
      //TODO(jondruse) should there be waiting (blocking) for handleConnectionFailure?
   }
      ...
      public void run() {
         ...
         scheduledThreadPool.schedule(() -> {
               try {
                  ...
                  //TODO(jondruse) how corrctly log thie error
                  e.printStackTrace();
               }
